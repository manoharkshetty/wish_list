...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { brand: @wish.brand, color: @wish.color, item: @wish.item, picture: @wish.picture }
    end
  ...
  test "should update wish" do
    patch :update, id: @wish, wish: { brand: @wish.brand, color: @wish.color, item: @wish.item, picture: @wish.picture }
    assert_redirected_to wish_path(assigns(:wish))
  end
